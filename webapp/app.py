...
st.markdown("<h1 style='text-align: center; color: #494848;'>Detection of Phishing Websites using Machine Learning</h3>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; color: #494848;'>Phishing website detection using machine learning algorithms to analyze website features and identify malicious URLs. </p>", unsafe_allow_html=True)
